...
-- ============================================================================
-- Next steps:
-- 1. Create storage buckets manually in Supabase Dashboard (Storage section):
--    - Create 'avatars' bucket (public)
--    - Create 'receipts' bucket (private)
-- 2. Go to Authentication → Providers and enable Email authentication
-- 3. Enable "Confirm Email" in Email provider settings
-- 4. Test by creating a user through the Flutter app
-- ============================================================================
